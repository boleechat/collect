...
class Spider(Spider):
    ...
    # API URL templates
    api_url_template = "https://pc.api.btime.com/btimeweb/infoFlow?list_id=btv_08da67cea600bf3c78973427bfaba12d_s0_{year}_{month:02d}&refresh=1&count=31"
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        all_videos = self.fetchVideosForYear(tid, limit=100)
    ...
    def fetchDataForYear(self, year):
        ...
        for month in range(months_to_fetch, 0, -1):
            api_url = self.api_url_template.format(year=year, month=month)
